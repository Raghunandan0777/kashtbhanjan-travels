    ...
    <section className="py-20 sm:py-28 relative">
      ...
      >
        <div className="glass-strong rounded-3xl p-10 sm:p-16 gold-border-glow">
          ...
          <motion.a
            href={`https://wa.me/${BUSINESS.whatsapp}?text=${encodeURIComponent("Hello, I would like to know more about your travel services. Please share details.")}`}
            target="_blank"
          ...
          >
            <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current" aria-hidden="true" role="img">
