...
const REVIEWS = [
  ...
  },
  {
    ...
    location: "Mumbai",
    rating: 5,
    text: "Booked a tour to Rajasthan and it was an unforgettable experience. The vehicle was comfortable and the driver knew all the best routes. Will definitely use Kashtbhanjan Travels again!",
    initials: "PS",
  },
  {
    name: "Amit Patel",
  ...
  },
  {
    ...
    location: "Hyderabad",
    rating: 5,
    text: "Our family trip to Manali was made special by Kashtbhanjan Travels. The Ertiga was perfect for our family of 5, and the driver was patient and helpful throughout the journey.",
    initials: "SR",
  },
  {
    name: "Vikram Singh",
    location: "Jaipur",
    rating: 5,
    text: "Corporate travel needs handled perfectly. Reliable, professional, and always on time. Kashtbhanjan Travels has become our go-to service for all business travel requirements.",
    initials: "VS",
  },
];
