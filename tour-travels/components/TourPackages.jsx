...
const TOURS = [
  ...
  {
    name: "Rajasthan Tour",
    image: "/images/rajasthan_tour.png",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8">
          {TOURS.map((tour, i) => (
            ...
            >
              {/* Image */}
              <div className="relative h-56 sm:h-60 overflow-hidden group">
                <Image
                  src={tour.image}
                  alt={tour.name}
                  fill
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-grow">
                ...
                {/* WhatsApp Enquiry */}
                <a
                  href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(`Hi, I'm interested in the ${tour.name} package (${tour.duration}, ${tour.price}). Please share more details.`)}`}
                  target="_blank"
