...
const FLEET = [
  ...
  {
    name: "Maruti Ertiga",
    image: "/images/maruti_ertiga.webp",
  ...
  },
  {
    ...
    image: "/images/tempo_traveller.webp",
  ...
  {
    name: "Force Urbania",
    image: "/images/force_urbania.webp",
          ...
          {FLEET.map((car, i) => (
            <GlassCard key={car.name} delay={i * 0.1} className="flex flex-col">
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-grow">
                ...
                {/* WhatsApp Button */}
                <a
                  href={`https://wa.me/${BUSINESS.whatsapp}?text=${encodeURIComponent(`Hi, I'm interested in booking the ${car.name}. Please share details.`)}`}
                  target="_blank"
